...
fn main() {
    ...
    // note: need to store this alongside multisig object
    ...
    let value = Value::<TestnetV0>::from_str("{ recipient: aleo1hy0uyudcr24q8nmxr8nlk82penl8jtqyfyuyz6mr5udlt0g3vyfqt9l7ew, amount: 10u128 }").unwrap();
    ...
    let nonce = Scalar::<TestnetV0>::rand(rng);
    ...
    let signature = Signature::<TestnetV0>::from((challenge, response, compute_key));
    ...
    let cloned_value = Value::<TestnetV0>::from_str("{ recipient: aleo1hy0uyudcr24q8nmxr8nlk82penl8jtqyfyuyz6mr5udlt0g3vyfqt9l7ew, amount: 10u128 }").unwrap();
    ...
    // note: this is the same as cloned_value
    let multisig_value = Value::<TestnetV0>::from_str("{ recipient: aleo1hy0uyudcr24q8nmxr8nlk82penl8jtqyfyuyz6mr5udlt0g3vyfqt9l7ew, amount: 10u128 }").unwrap();
    ...
    let multisig_verify_value = Value::<TestnetV0>::from_str("{ recipient: aleo1hy0uyudcr24q8nmxr8nlk82penl8jtqyfyuyz6mr5udlt0g3vyfqt9l7ew, amount: 10u128 }").unwrap().to_fields().unwrap();
    assert!(multisig_signature.verify(&address, &multisig_verify_value));
    println!("verified");

    // note: end of multisig creation


    // Verifying a multisig signature with this account
    // note: same value as cloned_value
    // println!("---------Verifying a FROST Aleo Randomized Schnorr Signature---------");
    // println!("------------------------------------------------------------------------");
    // let multisig_verify_value = Value::<TestnetV0>::from_str("{ recipient: aleo1hy0uyudcr24q8nmxr8nlk82penl8jtqyfyuyz6mr5udlt0g3vyfqt9l7ew, amount: 10u128 }").unwrap();
    // println!("Multisig Verify Message value is {:?}", multisig_verify_value);
    // let multisig_verify_message: Vec<Field<TestnetV0>> = multisig_verify_value.to_fields().unwrap();
